"""
proyecto_1 / main.py
Gráfica de N vs tiempo de ejecución para los métodos
len, copiar e invertir de ListaDobleEnlazada.
"""
...
plt.tight_layout()
plt.savefig("data/grafica_tiempos_LDE.png", dpi=150, bbox_inches="tight")
plt.show()
